...
<div style="border-radius: 10px;background: #2bbbada8;box-shadow: 0px 5px 30px 10px #0000007a;" class="container my-5 p-5  animated pulse">
  ...
  <section class="text-center black-text">
    ...
    <!-- Section heading -->
    <h2 style="font-size:50px;" class="font-weight-bold mb-4 pb-2 text-uppercase"><?php echo $habitacion['nombre']?> 
    <a href="activarHabit.php?prueba=1&id=<?php echo $habitacion['habitacion']?>" id="modoPrueba" class="btn-blue btn">Arduino modo prueba</a>
    <a data-toggle="modal" data-target="#modalHerramienta"  class="btn-purple btn">Cartel Arduino</a></h2>
