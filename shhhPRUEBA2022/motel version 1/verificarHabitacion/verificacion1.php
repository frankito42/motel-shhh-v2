...
<div style="border-radius: 10px;background: #2b43bb8c;box-shadow: 0px 5px 30px 10px #0000007a;" class="container my-5 p-5  animated pulse">
  ...
  <section class="text-center black-text">
    ...
    <!-- Section heading -->
    <h2 style="font-size:50px;" class="font-weight-bold mb-4 pb-2 text-uppercase"><?php echo $habitacion['nombre']." necesita limpieza"?></h2>
    <!-- Section description -->
    <!-- Grid row -->
    <!-- Grid row -->
  ...
  <div style="width:25%;float:left;">
   ...
   <a id="finVerificacion" class="btn btn-blue btn-lg">Iniciar limpieza</a>
  ...
  <div style="width:65%;float:right;">
      <button class="btn purple-gradient btn-sm" data-toggle="modal" data-target="#modalCheck">Nuevo item</button>
  <div class="row">
    <div class="col-sm">
    <?php
    for ($i=0; $i < $aux ; $i++):
...
<script>
document.getElementById("finVerificacion").addEventListener("click",()=>{
  document.getElementById('finVerificacion').disabled =true
